...
<main>
  ...
  <div class="bodycontainer">
    ...
    <br></br>
    <font face="Superspace" size="10" color="black"><b>Mortal Kombat X</b></font>
    <div class="line" style="height: 5px;"></div>
<!-- ลิงค์วิดิโอใส่ youtube.com/embed/xxxxx  -->
    <div class="content has-text-centered"><iframe width="900px" height="600px" src="https://youtube.com/embed/jSi2LDkyKmI" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>
    <!-- ส่วนสไลด์ภาพ ปรับให้ภาพขนาดเท่ากัน อันนี้ใช่ 900 x 600 (ปรับใน ps) ตั้งชื่อไฟล์ตามเกม ได้แก้ง่ายๆ-->

    <section class="autoplay slider">
      <div>
        <img src="assets/mx1.jpg">
      </div>
      <div>
        <img src="assets/mx2.webp">
      </div>
      <div>
        <img src="assets/mx3.jpg">
      </div>
      <div>
        <img src="assets/mx4.jpg">
      </div>
      <div>
        <img src="assets/mx5.jpg">
      </div>
      <div>
        <img src="assets/mx6.jpg">
      </div>
    </section>
