  ...
  <main>
    ...
    <div class="bodycontainer">
      <div class="content has-text-centered has-text-black">
        <br>
        <h1 align="left"><font face="Superspace" style="font-size:50pt"><b>Sledgehammer ประกาศ ระบบ Dedicated Server สำหรับ Call of Duty: WWII กลับมาใช้ได้ตามปกติบนทุกแพลตฟอร์มแล้ว!</b></font></h1>
        <div class="line" style="height: 5px;"></div><br>
        <h5 align="left"><font face="RSU text" size="6">มากกว่า 9000 ชม. ที่แล้ว</font></h5><br>
          <img src="/assets/New03.jpg" height="auto" width="900px">
          </br>
          <br></br>
          <font face="RSU text" size="18px">
            <p align="left">

          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ก่อนหน้านี้ Call of Duty: WWII ได้มีปัญหาเซิร์ฟเวอร์ ปัญหาการแครชและปัญหาด้านเทคนิคหลายอย่าง จึงทำให้ Sledgehammer ผู้พัฒนาตัดสินใจที่จะปิดระบบ Dedicate Servers ของ Call of Duty: WWII ไปชั่วคราวก่อน และกลับไปใช้ระบบ P2P แทน<br>

          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ล่าสุดทาง Sledgehammer ได้ประกาศอย่างเป็นทางการว่า ระบบ Dedicated Servers สำหรับ Call of Duty: WWII ได้เปิดให้ใช้งานตามปกติแล้วทั้งบน Ps4, Xbox One และ Steam <br>

          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"อัพเดตสถานะ : Global Dedicated Servers ได้เปิดให้ใช้งานตามปกติแล้วบนทุกแพลตฟอร์ม ถ้าคุณพบปัญหาใดๆ โปรดระบุปัญหานั้นเท่าที่ะเป็นไปได้ในคำตอบรวมทั้งระบุประเภทการเชื่อมต่ือ ไม่ว่าจะเป็น Wired/wifi, NAT และโซน รวมถึงเมนชั่นไปที่ @ATVIassist ด้วย"<br>

          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เอาเป็นว่าใครที่เล่นเกมนี้อยู่ก็ลองเช็คระบบออนไลน์ของตัวเองดูกันนะแจ้<br>
            </p></font>

            <b></b>
            <p align="right">
              <strong>แหล่งข้อมูลจาก</strong> <A href="https://www.vg247.com/2017/11/15/call-of-duty-ww2-dedicated-servers-have-been-fully-enabled-on-all-platforms/" style="color:red">Web Master</A>
          </p>
      </div>
    </div>
