...
window.onclick = function(event) {
  ...
  <div class="slideshow-container is-paddingless">
    <div class="mySlides w3-animate-right">
      ...
      <a href="new6.html">
      <img src="assets/B1NEW.jpg" style="width:100%">
    ...
    <div class="mySlides w3-animate-right">
      <div class="numbertext"></div>
      <a href="rmaster3.html">
      <img src="assets/B2NEW.jpg" style="width:100%" >
<div class="w3-display-bottommiddle w3-container w3-padding-16 w3-black">
   <font face="Superspace" size="5">[Review] Need for Speed การกลับมาของเกมรถซิ่งข้างถนน</font>
    ...
    <div class="mySlides w3-animate-right">
      <div class="numbertext"></div>
      <a href="rmaster1.html">
      <img src="assets/B3.jpg" style="width:100%">
      <div class="w3-display-bottommiddle w3-container w3-padding-16 w3-black">
  ...
  <body  class="bodyScope" >
    ...
    <div class="columns ">
      <div class="column is-6">
        <div class="big">
          <div class="card"><a href="new1.html">
            <div class="card-content">
              <div class="image">
                <img src="assets/New01.jpg" alt="image-1">
              </div>
              <div class="content">
      ...
      <div class="small">
        <div class="columns is-multiline">
          <div class="column">
            <div class="card"><a href="new2.html">
              <div class="card-content ">
                <div class="image">
                  <img src="assets/New02.jpg" alt="image-1" >
                </div>
                <div class="content">
          ...
          <div class="column">
            <div class="card"><a href="new3.html">
              <div class="card-content ">
                <div class="image">
                  <img src="assets/New03.jpg" alt="image-1" >
                </div>
                <div class="content">
        ...
        <div class="columns is-multiline">
          <div class="column">
            <div class="card"><a href="new4.html">
              <div class="card-content ">
                <div class="image">
                  <img src="assets/New04.jpg" alt="image-1" >
                </div>
                <div class="content">
          ...
          <div class="column">
            <div class="card"><a href="new5.html">
              <div class="card-content ">
                <div class="image">
                  <img src="assets/New05.jpg" alt="image-1" >
                </div>
                <div class="content">
    ...
    <div class="foot">
      <div class="columns is-multiline">
        <div class="column">
          <div class="card"><a href="rmaster1.html">
            <div>
              <img class="image" src="assets/B4.jpg" alt="image-1">
            </div>
            <div class="content">
        ...
        <div class="column">
          <div class="card"><a href="rmaster2.html">
            <div>
              <img class="image" src="assets/Hyperdimension_Neptunia_Re_Birth1.jpg" alt="image-1">
            </div>
            <div class="content">
        ...
        <div class="column">
          <div class="card"><a href="rmaster3.html">
            <div>
                <img class="image" src="assets/need-for-speed-2015.jpg" alt="image-1">
            </div>
            <div class="content">
        ...
        <div class="column">
          <div class="card"><a href="rmaster4.html">
            <div class="">
              <img class="image" src="assets/marco.jpg" alt="image-1">
            </div>
            <div class="content">
