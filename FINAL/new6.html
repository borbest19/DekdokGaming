...
<main>
  ...
  <div class="bodycontainer">
    <div class="content has-text-centered has-text-black">
      <br>
      <h1 align="left"><font face="Superspace" style="font-size:50pt"><b>ครั้งแรกที่เกมซีรีส์ Touhou ได้ขึ้นแพลตฟอร์มสตีม</b></font></h1>
      <div class="line" style="height: 5px;"></div><br>
      <h5 align="left"><font face="RSU text" size="6">มากกว่า 9000 ชม. ที่แล้ว</font></h5><br>
      <img src="/assets/New06.jpg" height="auto" width="900px">
      </br>
      <br></br>
      <font face="RSU text" size="18px">
        <p align="left">

          >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ตอนนี้ 東方天空璋 ～ Hidden Star in Four Seasons หรือ Touhou Tenkuushou ~ Hidden Star in Four Seasons เกมลำดับที่ 16 ใน Touhou Project ของ ZUN ที่วางจำหน่ายในงาน Comicket ครั้งที่ 92 เมื่อเดือนสิงหาคมที่ผ่านมา ตอนนี้ก็ได้ขึ้นในหน้าร้านค้าสตีมเป็นที่เรียบร้อยแล้วนะครัช
          แม้ว่าจะยังไม่ระบุราคาแต่ก็ระบุวันวางจำหน่ายมาแล้วนั่นคือ 18 พ.ย.นี้ ซึ่งตัวเกม 東方天空璋 ～ Hidden Star in Four Seasons บนสตีมจะรองรับแต่ภาษาญี่ปุ่นเพียงอย่างเดียว และนี่เป็นครั้งแรกที่เกมซีรีส์ Touhou ได้ขึ้นแพลตฟอร์มสตีม แบบนี้ถ้าขายดีจะเอาภาคเก่าๆมาลงด้วยมั้ยหว่า?
        </p>
      </font>
        <br>
        <p align="right">
          <strong>แหล่งข้อมูลจาก</strong>
          <A href="https://www.facebook.com/goodgamecheapprice/" style="color:red">Web Master</A>
        </p>
    </div>
  </div>
