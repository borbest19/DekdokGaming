...
<main>
  ...
  <div class="bodycontainer">
    ...
    <br></br>
    <font face="Superspace" size="10" color="black"><b>Hyperdimension Neptunia Re;Birth1</b></font>
    <div class="line" style="height: 5px;"></div>
<!-- ลิงค์วิดิโอใส่ youtube.com/embed/xxxxx  -->
    <div class="content has-text-centered"><iframe width="900" height="600" src="https://www.youtube.com/embed/z27LSWNKhPg" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>
    <!-- ส่วนสไลด์ภาพ ปรับให้ภาพขนาดเท่ากัน อันนี้ใช่ 900 x 600 (ปรับใน ps) ตั้งชื่อไฟล์ตามเกม ได้แก้ง่ายๆ-->

    <section class="autoplay slider">
      <div>
        <img src="assets/hyre1.jpg">
      </div>
      <div>
        <img src="assets/hyre2.jpg">
      </div>
      <div>
        <img src="assets/hyre3.jpg">
      </div>
      <div>
        <img src="assets/hyre4.jpg">
      </div>
      <div>
        <img src="assets/hyre5.jpg">
      </div>
      <div>
        <img src="assets/hyre6.jpg">
      </div>
    </section>
