...
<head>
  ...
  <link rel="stylesheet" href="\ReviewUser\reviewuser.css">
...
<main>
  ...
  <div class="bodycontainer">
    ...
    <br></br>
    <font face="Superspace" size="10" color="black"><b>Hyperdimension Neptunia U: Action Unleashed</b></font>
    <div class="line" style="height: 5px;"></div>
<!-- ลิงค์วิดิโอใส่ youtube.com/embed/xxxxx  -->
    <div class="content has-text-centered"><iframe width="900" height="600" src="https://www.youtube.com/embed/sh8zc0e7NZE" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>
    <!-- ส่วนสไลด์ภาพ ปรับให้ภาพขนาดเท่ากัน อันนี้ใช่ 900 x 600 (ปรับใน ps) ตั้งชื่อไฟล์ตามเกม ได้แก้ง่ายๆ-->

    <section class="autoplay slider">
      <div>
        <img src="assets/hyu1.jpg">
      </div>
      <div>
        <img src="assets/hyu2.jpg">
      </div>
      <div>
        <img src="assets/hyu3.jpg">
      </div>
      <div>
        <img src="assets/hyu4.jpg">
      </div>
      <div>
        <img src="assets/hyu5.jpg">
      </div>
      <div>
        <img src="assets/hyu6.jpg">
      </div>
    </section>
...
<footer class="footer" background-color="#8c0009">
  <div class="container">
    <div class="content has-text-centered has-text-white">
      <p>
        <a href=/index.html>
       <img src="/DDG/static/assets/LogoWeb/dekdoklogoblack.png" alt="logo" width="150px" align="center" style="margin-top:-40px;"> </a><br>
        <a href="/Aboutus/index.html" target="_blank">
